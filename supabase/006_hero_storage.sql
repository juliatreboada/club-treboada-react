-- =============================================================================
-- Club Treboada - Storage bucket for hero carousel images
-- =============================================================================
-- Run after hero_slides.sql. Creates public bucket `hero-images` and
...
drop policy if exists "hero_images_insert_staff" on storage.objects;
...
drop policy if exists "hero_images_update_staff" on storage.objects;
...
drop policy if exists "hero_images_delete_staff" on storage.objects;
